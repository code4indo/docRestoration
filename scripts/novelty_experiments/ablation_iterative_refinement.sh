#!/bin/bash
# Ablation Study: Iterative Refinement (Dengan Attention-Guided Refinement)

echo "=================================================================="
echo "🔄 Ablation Study: Iterative Refinement (Dengan Attention-Guided Refinement)"
echo "=================================================================="
...
EXP_NAME="ablation_iterative_refinement"
...
# Run training with iterative refinement parameters (same as baseline for valid comparison)
echo "🚀 Starting iterative refinement training (WITH Attention-Guided Refinement)..."
...
echo "✅ Ablation iterative refinement experiment finished."
