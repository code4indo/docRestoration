...
def bluche(input_size, d_model):
    ...
    blstm = Bidirectional(GRU(units=128, return_sequences=True))(blstm)
...
def puigcerver(input_size, d_model):
    ...
    blstm = Bidirectional(GRU(units=256, return_sequences=True, dropout=0.5))(blstm)
    blstm = Bidirectional(GRU(units=256, return_sequences=True, dropout=0.5))(blstm)
    blstm = Bidirectional(GRU(units=256, return_sequences=True, dropout=0.5))(blstm)
    blstm = Bidirectional(GRU(units=256, return_sequences=True, dropout=0.5))(blstm)
    blstm = Bidirectional(GRU(units=256, return_sequences=True, dropout=0.5))(blstm)
...
def puigcerver_octconv(input_size, d_model):
    ...
    high = LeakyReLU(negative_slope=0.01)(high)
    low = LeakyReLU(negative_slope=0.01)(low)
