...
def process_tile(tile_img, generator):
    """Process a single tile through the generator."""
...
def blend_tiles_horizontal(tiles_data, full_width, full_height, overlap_ratio=0.15):
    """
...
def process_portrait_document(image, generator, logger, alpha=0.15):
    ...
    if aspect < 1.5:
        ...
        columns = split_vertical_columns(image, num_columns=num_columns, overlap_ratio=0.1)
