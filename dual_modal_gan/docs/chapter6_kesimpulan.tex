...
Untuk mengatasi keterbatasan teknis dan memperluas cakupan keilmuan, penelitian mendatang disarankan untuk berfokus pada:
...
\begin{enumerate}[leftmargin=1.5em, labelsep=0.5em, itemindent=0pt, noitemsep, topsep=0pt]
  ...
  \item Arsitektur Diskriminator yang Lebih Efisien: Mengganti desain dual-modal dengan diskriminator visual tunggal yang lebih ringan, serta mengeksplorasi fungsi \textit{loss} alternatif untuk menggantikan komponen RecFeat yang terbukti redundan.
