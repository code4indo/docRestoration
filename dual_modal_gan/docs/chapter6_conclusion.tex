...
\begin{enumerate}[label=\arabic*., leftmargin=0.5cm]
    ...
    \item \textbf{Adversarial Loss Sensitivity:} Bobot adversarial loss ($\lambda_{adv}$) memiliki sensitivitas signifikan dengan threshold bahaya $\geq$ 6.0 yang menyebabkan mode collapse. Zona optimal: 2.0-5.0.
...
\begin{enumerate}[label=\arabic*., leftmargin=0.5cm]
    ...
    Mengidentifikasi sensitivitas signifikan adversarial loss weight (66.4\% importance) dan threshold bahaya mode collapse ($\lambda_{adv} \geq 6.0$), memberikan panduan empiris untuk training stable GAN.
