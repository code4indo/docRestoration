...
\begin{enumerate}[leftmargin=1.5em, labelsep=0.5em, itemindent=0pt, noitemsep, topsep=0pt]
    ...
    \item Segenap Dosen dan Staf Pengajar di Program Pascasarjana STEI ITB yang telah memberikan bekal ilmu pengetahuan yang sangat bermanfaat selama masa perkuliahan.
...
% \setlength{\parskip}{0pt} % DIHAPUS: agar tidak mereset parskip global
