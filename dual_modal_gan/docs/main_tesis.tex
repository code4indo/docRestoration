...
\noindent\textbf{Kata Kunci:} Restorasi Dokumen, GAN, HTR, Diskriminator Dual-Modal, Optimasi Loss Function
...
\noindent\textbf{Keywords:} Document Restoration, GAN, HTR, Dual-Modal Discriminator, Loss Function Optimization
...
\\\\
\\\\
[NAMA DIREKTUR] dan [NAMA KETUA PRODI]\\
NIP. [NIP] & NIP. [NIP]
\end{tabular}
