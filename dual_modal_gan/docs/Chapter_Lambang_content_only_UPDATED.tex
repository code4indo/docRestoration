...
\multicolumn{1}{c}{\textbf{SINGKATAN}} & \multicolumn{1}{c}{\textbf{Nama}} & \multicolumn{1}{c}{\textbf{Hal.}} \\
...
ANRI & Arsip Nasional Republik Indonesia & 12 \\
API & \textit{Application Programming Interface} & 66 \\
BCE & \textit{Binary Cross-Entropy} & 19 \\
BiGRU & \textit{Bidirectional Gated Recurrent Unit} & 19 \\
BiLSTM & \textit{Bidirectional Long Short-Term Memory} & 73 \\
CBAM & \textit{Convolutional Block Attention Module} & 78 \\
CER & \textit{Character Error Rate} & 1 \\
cGAN & \textit{Conditional Generative Adversarial Network} & 17 \\
CLI & \textit{Command-Line Interface} & 66 \\
CNN & \textit{Convolutional Neural Network} & 2 \\
CRNN & \textit{Convolutional Recurrent Neural Network} & 18 \\
CTC & \textit{Connectionist Temporal Classification} & 2 \\
CUDA & \textit{Compute Unified Device Architecture} & 68 \\
cuDNN & \textit{CUDA Deep Neural Network library} & 68 \\
CWV & \textit{Core Web Vitals} & 95 \\
DE-GAN & \textit{Document Enhancement GAN} & 1 \\
DIBCO & \textit{Document Image Binarization Contest} & 13 \\
DocEnTr & \textit{Document Enhancement Transformer} & 1 \\
DRD & \textit{Distance Reciprocal Distortion} & 19 \\
DSRM & \textit{Design Science Research Methodology} & 5 \\
ERB & \textit{Enhance to Read Better} & 2 \\
FCN & \textit{Fully Convolutional Network} & 18 \\
FM & \textit{F-measure} & 19 \\
Fps & \textit{pseudo-F-measure} & 19 \\
FR & \textit{Functional Requirement} & 65 \\
GAN & \textit{Generative Adversarial Network} & 1 \\
GPU & \textit{Graphics Processing Unit} & 35 \\
GT & \textit{Ground Truth} (Kebenaran Dasar) & 20 \\
H-DIBCO & \textit{Handwritten Document Image Binarization Contest} & 21 \\
HMM & \textit{Hidden Markov Model} & 30 \\
HTR & \textit{Handwritten Text Recognition} & 1 \\
IAM & \textit{IAM Handwriting Database} & 19 \\
ICDAR & \textit{International Conference on Document Analysis and Recognition} & 25 \\
IIIT5K & \textit{IIIT 5K-word dataset} & 25 \\
KHATT & \textit{Arabic Handwritten Text Database} & 19 \\
LSTM & \textit{Long Short-Term Memory} & 2 \\
MAE & \textit{Mean Absolute Error} & 30 \\
ML & \textit{Machine Learning}  & 65 \\
MLflow & \textit{Machine Learning Flow} & 62 \\
MSE & \textit{Mean Squared Error}  & 14 \\
MSFP & \textit{Multi-Scale Feature Pyramid} & 78 \\
NFR & \textit{Non-Functional Requirement}  & 66 \\
OCR & \textit{Optical Character Recognition} & 21 \\
PALM & \textit{Presentation Attack Liveness Detection in Mobile scenarios} & 29 \\
Pix2Pix & \textit{Image-to-Image Translation with Conditional Adversarial Networks} & 17 \\
PSNR & \textit{Peak Signal-to-Noise Ratio} & 1 \\
RDB & \textit{Residual Dense Block} & 78 \\
RMSProp & \textit{Root Mean Square Propagation} & 20 \\
RNN & \textit{Recurrent Neural Network}  & 18 \\
SDM & Sumber Daya Manusia & 60 \\
SGD & \textit{Stochastic Gradient Descent} & 89 \\
SNR & \textit{Signal-to-Noise Ratio}  & 105 \\
SOP & \textit{Standard Operating Procedure}  & 65 \\
SOTA & \textit{State-of-the-Art} & 21 \\
SSIM & \textit{Structural Similarity Index Measure} & 1 \\
UNESCO & \textit{United Nations Educational, Scientific and Cultural Organization} & 1 \\
U-Net & \textit{U-shaped Convolutional Network} & 5 \\
VGG & \textit{Visual Geometry Group} & 38 \\
ViT & \textit{Vision Transformer} & 25 \\
VOC & \textit{Visual Object Classes} & 12 \\
WER & \textit{Word Error Rate} & 2 \\
...
\multicolumn{1}{c}{\textbf{LAMBANG}} & \multicolumn{1}{c}{\textbf{NAMA}} & \multicolumn{1}{c}{\textbf{Hal.}} \\
