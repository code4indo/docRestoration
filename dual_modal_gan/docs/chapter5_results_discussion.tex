...
\midrule
\texttt{adv\_loss\_weight} & \textbf{66.4\%} & \textbf{PARAMETER PALING PENTING}. Memiliki dampak terbesar pada skor objektif. Korelasi negatif kuat: nilai tinggi $\rightarrow$ performa buruk (risiko \textit{mode collapse}) \\
...
\begin{enumerate}
    \item \textbf{Sensitivitas Signifikan Bobot Adversarial:} 
    \begin{itemize}
...
\begin{itemize}
    ...
    \item Sensitivitas parameter: adv\_loss\_weight paling penting (66.4\% importance)
\end{itemize}
