...
1. Modalitas Visual: Evaluasi karakteristik spasial dan tekstur citra melalui jaringan konvolusional, mengikuti paradigma PatchGAN \cite{isola2017} yang menilai keaslian pada tingkat patch lokal.
...
2. \textit{Adaptive Weighting}: \textcite{chen2018gradnorm} mengusulkan \textit{GradNorm} yang secara dinamis menyesuaikan bobot berdasarkan magnitudo relatif gradien dari setiap loss. Berpotensi mencapai keseimbangan otomatis.
...
\vspace{0.3em}
Penelitian ini mengisi celah penting dalam literatur melalui tiga dimensi inovasi yang secara langsung mengatasi kesenjangan yang teridentifikasi: (1) \textbf{Integrasi HTR dengan Frozen Recognizer}, strategi yang memecahkan masalah ketidakstabilan \textit{joint training} sambil memberikan gradien HTR-peka yang konsisten untuk optimasi keterbacaan teks; (2) \textbf{Curriculum Learning untuk Stabilitas Training}, dengan strategi CTC loss annealing yang mencegah dominasi satu komponen loss pada fase awal training GAN multi-objective; dan (3) \textbf{Optimisasi Loss Function Multi-Komponen}, dengan formulasi bobot optimal yang divalidasi empiris melalui studi ablasi sistematis untuk mencapai keseimbangan antara kualitas visual (PSNR/SSIM) dan keterbacaan teks (CER/WER) pada dokumen historis autentik.
