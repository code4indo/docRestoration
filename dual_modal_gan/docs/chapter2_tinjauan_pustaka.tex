...
% Menggunakan \@startsection untuk kontrol penuh dengan jarak sama seperti level 3
\makeatletter
\renewcommand\paragraph{\@startsection{paragraph}{4}{\z@}%
  {0.5cm}%                           % Space before heading (sama dengan subsubsection)
  {0.5pt}%                             % Space after heading (positif = baris baru, 0pt = langsung ke teks)
...
\renewcommand{\theparagraph}{\thesubsubsection.\arabic{paragraph}}  % Level 4 numbering
...
ERB-MultiTask (2021) & 15.7 dB & 0.87 & 27.03 / 24.33\% & \checkmark\textsuperscript{1,2} \\ \hline
...
ERB-MultiTask (2021) & Visual saja & FCN + CRNN & Adv + CRNN \\ \hline
