...
\begin{table}[H]
      ...
      \begin{tabular}{|p{2.8cm}|c|c|c|p{2.5cm}|}
            ...
            \hline
            (A) Tinta Tembus                     & Sedang           & +40\%                 & -60\%                    & \cite{gatos2006}             \\
            \hline
            (B) Korosi Tinta Besi Galat          & Sedang           & +35\%                 & -50\%                    & \cite{neevel1995,krekel1999} \\
            \hline
            (C) Penuaan Kertas / Penguningan     & Sedang           & +40\%                 & -55\%                    & \cite{reilly1993,porck2000}  \\
            \hline
            (D) Kerusakan Fisik (Robek, Lipatan) & Berat            & +60\%                 & -70\%                    & \cite{gatos2006}             \\
            \hline
            (E) Pemudaran Tinta                  & Sedang           & +25\%                 & -45\%                    & \cite{pratikakis2013}        \\
            \hline
            (F) Degradasi Gabungan               & Berat            & +85\%                 & -80\%                    & \cite{souibgui2022docentr}   \\
            \hline
      \end{tabular}
\end{table}
...
\textit{Fase 2: Era Pembelajaran Mendalam Awal (2015-2018)} -- Transisi ke pembelajaran representasi dengan U-Net \cite{ronneberger2015} dan autoencoder. Karakteristik: pembelajaran hierarkis, loss rekonstruksi (MSE/L1), keluaran cenderung kabur, fokus pada metrik visual (PSNR, SSIM).

\textit{Fase 3: Era Adversarial dan Multi-Modal (2017-2024)} -- Kemunculan GAN (Pix2Pix 2017, DE-GAN 2021), integrasi HTR (ERB-MultiTask 2021), dan munculnya pendekatan berbasis transformer (DocEnTr 2022, Text-DIAE 2022). Karakteristik: pelatihan adversarial untuk realisme, eksplorasi integrasi pengenal, adopsi mekanisme attention, dan eksplorasi terkini dari diffusion models (\cite{chen2018gradnorm}).

\textit{Fase 4: Era Paradigma Baru (2023-2024)} -- Pengenalan pendekatan pembelajaran mandiri (\cite{zhang2024}), vision transformers untuk analisis dokumen (\cite{kiessling2023}), dan mekanisme attention multi-skala (\cite{martinez2024}). Karakteristik: ketergantungan yang berkurang pada data pelatihan berpasangan, mekanisme attention berbasis transformasi dengan resolusi hierarkis, dan kerangka evaluasi holistik yang melampaui metrik tradisional (\cite{thompson2023}).
...
\begin{enumerate}[leftmargin=1.5em, labelsep=0.5em, itemindent=0pt, label=\alph*., topsep=0pt, parsep=0pt, itemsep=0pt]
      ...
      \item Kontras dengan ERB: Berbeda dari ERB-MultiTask \cite{souibgui2021erb} yang mengintegrasikan pengenal, DE-GAN mengambil pendekatan tanpa integrasi
\end{enumerate}
...
\begin{table}[H]
      ...
      \resizebox{\textwidth}{!}{
            \begin{tabular}{|l|c|c|}
                  \hline
                  Aspek                    & ERB-MultiTask \cite{souibgui2021erb}          & DE-GAN \cite{souibgui2021degan} \\ \hline
...
\begin{enumerate}[leftmargin=1.5em, labelsep=0.5em, itemindent=0pt, label=\alph*., topsep=0pt, parsep=0pt, itemsep=0pt]
      \item Modalitas Visual: \mbox{} Evaluasi karakteristik spasial dan tekstur citra melalui jaringan konvolusional, mengikuti paradigma PatchGAN \cite{isola2017} yang menilai keaslian pada tingkat patch lokal.
...
\begin{table}[H]
      ...
      \resizebox{\textwidth}{!}{%
            \begin{tabular}{|l|c|c|c|c|}
                  ...
                  \textbf{Otsu} \cite{otsu1979}          & T/A           & T/A           & --              & \texttimes                      \\ \hline
                  \textbf{Sauvola} \cite{sauvola2000}    & T/A           & 0.68          & --              & \texttimes                      \\ \hline
                  U-Net \cite{ronneberger2015}           & T/A           & T/A           & --              & \texttimes\textsuperscript{2}   \\ \hline
                  \textbf{Pix}2Pix \cite{isola2017}      & T/A           & T/A           & --              & \texttimes\textsuperscript{2}   \\ \hline
                  ERB-MultiTask \cite{erb2021}           & 15.7 dB       & 0.87          & 27.03 / 24.33\% & \checkmark\textsuperscript{1,2} \\ \hline
                  DE-GAN \cite{souibgui2021}             & 15.5 dB       & 0.86          & 28.2\%          & \checkmark\textsuperscript{1,2} \\ \hline
                  \textbf{Text}-DIAE \cite{textdiae2022} & 28.5 dB       & 0.88          & --              & \texttimes                      \\ \hline
                  \textbf{Doc}EnTr \cite{docentr2022}    & 35.2 dB       & 0.92          & --              & \texttimes                      \\ \hline
                  \textbf{Cycle}GAN \cite{zhu2017}       & 30.2 dB       & 0.90          & --              & \texttimes                      \\ \hline
            \end{tabular}
      }
\end{table}
...
\begin{table}[H]
      ...
      \resizebox{\textwidth}{!}{%
            \begin{tabular}{|l|c|c|c|}
                  ...
                  \textbf{Otsu} \cite{otsu1979}          & T/A                    & N/A                  & Threshold          \\ \hline
                  \textbf{Sauvola} \cite{sauvola2000}    & T/A                    & N/A                  & Adaptif            \\ \hline
                  U-Net \cite{ronneberger2015}           & T/A                    & CNN Encoder-Decoder  & L2 (MSE)           \\ \hline
                  \textbf{Pix}2Pix \cite{isola2017}      & Visual saja            & CNN U-Net + PatchGAN & Adv + L1           \\ \hline
                  ERB-MultiTask \cite{erb2021}           & Visual saja            & FCN + CRNN           & Adv + CRNN         \\ \hline
                  DE-GAN \cite{souibgui2021}             & Visual saja            & CNN U-Net            & Adv + BCE          \\ \hline
                  \textbf{Text}-DIAE \cite{textdiae2022} & T/A                    & ViT Autoencoder      & Rekonstruksi       \\ \hline
                  \textbf{Doc}EnTr \cite{docentr2022}    & T/A                    & Transformer Only     & MSE                \\ \hline
                  \textbf{Cycle}GAN \cite{zhu2017}       & Visual saja            & CNN Encoder-Decoder  & Cycle + Adv        \\ \hline
            \end{tabular}
      }
\end{table}

{\footnotesize\textsuperscript{1}DE-GAN dan ERB-MultiTask: Evaluasi pasca-pelatihan dengan pengenal yang telah dilatih sebelumnya, bukan pelatihan terintegrasi. Data PSNR/CER direvisi berdasarkan sumber asli \cite{souibgui2021erb,souibgui2022docentr}.
