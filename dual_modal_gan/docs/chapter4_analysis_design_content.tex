...
\hline
Text-DIAE & CNN-based & - (no pelatihan adversarial) & Post-training eval & No pelatihan adversarial \\
\hline
...
Arsitektur yang diusulkan terdiri dari tiga komponen utama yang berinteraksi dalam sebuah kerangka \textnormal{pelatihan adversarial}, seperti yang diilustrasikan pada Gambar \ref{fig:arch_overview}:
